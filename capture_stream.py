...
def main(argv):
  ...
  parser.add_argument('-o', dest='outfile', metavar='OUTFILE.mp3', required=False,
                      help='file to save the audio to (default stdout)')
  parser.add_argument('-D', '--duration', metavar='secs', required=False,
                      type=float, default=10.0, help='duration in seconds')
